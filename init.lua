...
-- [[ Basic Keymaps ]]
-- Note(ryan): Adding new keybinds (2024-02-13)
...
vim.keymap.set("n", "<C-d>", "<C-d>zz") -- keep cursor in the middle when jumping
...
cmp.setup {
  ...
  mapping = cmp.mapping.preset.insert {
    ...
    -- Note(ryan): may want the following to allow for a select=false option later
